...
client.on("messageCreate", async (message) => {
    if (message.author.id == "236552969544269826") {
        if (message.content == "%rank") {
            ...
            const msgRank = await message.channel.send("Chagement du module... <a:load:895199688645546016>");
        ...
        if (message.content == "%init") {
            client.channels.cache.get(message.channel.id).messages.fetch(message.id).then(message => message.delete());
            const msg = await message.channel.send("Les stats arrivent... <a:load:895199688645546016>");
